...
def LLweighted_MSE_Climax(preds: np.ndarray, y: np.ndarray, deg2rad: bool = True, mask=None):
    """
...
def LLweighted_RMSE_Climax(preds: np.ndarray, y: np.ndarray, deg2rad: bool = True, mask=None):
    """
