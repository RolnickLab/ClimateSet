...
from emulator.src.core.metrics import RMSE, NRMSE_s_ClimateBench, NRMSE_g_ClimateBench, NRMSE_ClimateBench, LLWeighted_RMSE_WheatherBench, LLweighted_MSE_Climax, LLweighted_RMSE_Climax
...
def evaluate_per_target_variable(Ytrue: dict,
    ...
    var_stats = [evaluate_preds(Ytrue[var_name], preds[var_name]) for var_name in Ytrue.keys()]
