...
python run.py experiment=single_emulator/convlstm/MPI-ESM1-2-HR_convlstm_tas+pr_run-01.yaml seed=3423
python run.py experiment=single_emulator/convlstm/MPI-ESM1-2-HR_convlstm_tas+pr_run-01.yaml seed=22201
python run.py experiment=single_emulator/convlstm/MPI-ESM1-2-HR_convlstm_tas+pr_run-01.yaml seed=7
