...
#SBATCH --time=00:10:00                                  # set runtime

#SBATCH -o /home/mila/m/martin.pomsl/slurm-%j.out        # set log dir to home

# Note running:
# cd [X]/causalpaca/
# sbatch --partition=unkillable data/mother_data/test_mother_mp.sh
...
pwd
cp -r /network/scratch/m/martin.pomsl/causalpaca/  $SLURM_TMPDIR/
echo "pwd after copying data"
pwd
#rm -r $SLURM_TMPDIR/caiclone/results/
#cp -r /network/scratch/m/martin.pomsl/data/ $SLURM_TMPDIR/
...
#cp -r $SLURM_TMPDIR/causalpaca/data/data/* /network/scratch/m/martin.pomsl/causalpaca/data/data/
